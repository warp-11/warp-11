...
################################################################
# This is a generated script based on design: golfs_bd
#
...
\
  ...
  # Create instance: GolAxi_0, and set properties
  set block_name GolAxi
  set block_cell_name GolAxi_0
  if { [catch {set GolAxi_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  # attribute injected by build_golfs_axi.tcl. Trying to set it here
  ...
  # Create instance: axi_smc_hp — smartconnect from GolAxi master
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins GolAxi_0/s_axi]
  ...
  # GolAxi master → smartconnect → PS HP0_FPD slave (writes fb to PS DDR)
  connect_bd_intf_net -intf_net golfs_m_axi [get_bd_intf_pins GolAxi_0/m_axi] [get_bd_intf_pins axi_smc_hp/S00_AXI]
  ...
  [get_bd_pins GolAxi_0/s_axi_aresetn] \
  ...
  [get_bd_pins GolAxi_0/s_axi_aclk] \
  ...
  connect_bd_net -net golfs_irq \
    [get_bd_pins GolAxi_0/irq] \
  ...
  assign_bd_address -offset 0xB0000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs GolAxi_0/s_axi/reg0] -force
  # Mandelbrot AXI master reaches PS DDR (low 2 GB) via the HP0_FPD slave port.
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces GolAxi_0/m_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
