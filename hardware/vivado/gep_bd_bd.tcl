...
################################################################
# This is a generated script based on design: gep_bd
#
...
\
  ...
  # Create instance: GepPool_axi_0, and set properties
  set block_name GepPool_axi
  set block_cell_name GepPool_axi_0
  if { [catch {set GepPool_axi_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $GepPool_axi_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins GepPool_axi_0/s_axi]
  ...
  [get_bd_pins GepPool_axi_0/s_axi_aresetn] \
  ...
  [get_bd_pins GepPool_axi_0/s_axi_aclk] \
  ...
  assign_bd_address -offset 0xB0000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs GepPool_axi_0/s_axi/reg0] -force
