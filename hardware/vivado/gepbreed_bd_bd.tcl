################################################################
#
# This is a generated script based on design: gepbreed_bd
#
...
\
  ...
  # Create instance: GepBreed_axi_0, and set properties
  set block_name GepBreed_axi
  set block_cell_name GepBreed_axi_0
  if { [catch {set GepBreed_axi_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $GepBreed_axi_0 eq "" } {
  ...
  # Create instance: axi_smc_hp — smartconnect from the GepBreed_axi DMA
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins GepBreed_axi_0/s_axi]
  ...
  # GepBreed_axi DMA master → smartconnect → PS HPC0_FPD coherent slave — AxCACHE=0xF transactions snoop the APU caches
  connect_bd_intf_net -intf_net gepbreed_m_axi [get_bd_intf_pins GepBreed_axi_0/m_axi] [get_bd_intf_pins axi_smc_hp/S00_AXI]
  ...
  [get_bd_pins GepBreed_axi_0/s_axi_aresetn] \
  ...
  [get_bd_pins GepBreed_axi_0/s_axi_aclk] \
  ...
  assign_bd_address -offset 0xB0000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs GepBreed_axi_0/s_axi/reg0] -force
  # GepBreed_axi DMA master reaches PS DDR (low 2 GB) via the coherent HPC0_FPD slave port.
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces GepBreed_axi_0/m_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_LOW] -force
