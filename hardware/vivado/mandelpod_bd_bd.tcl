...
################################################################
# This is a generated script based on design: mandelpod_bd
#
...
# source mandelpod_bd_script.tcl
...
\
  ...
  # Create instance: MandelPod_axi_0, and set properties
  set block_name MandelPod_axi
  set block_cell_name MandelPod_axi_0
  if { [catch {set MandelPod_axi_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $MandelPod_axi_0 eq "" } {
  ...
  # Create instance: axi_smc_hp — smartconnect from MandelPod_axi master
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins MandelPod_axi_0/s_axi]
  ...
  # MandelPod_axi master → smartconnect → PS HP0_FPD slave (writes fb to PS DDR)
  connect_bd_intf_net -intf_net mandelpod_m_axi [get_bd_intf_pins MandelPod_axi_0/m_axi] [get_bd_intf_pins axi_smc_hp/S00_AXI]
  ...
  [get_bd_pins MandelPod_axi_0/s_axi_aresetn] \
  ...
  [get_bd_pins MandelPod_axi_0/s_axi_aclk] \
  ...
  connect_bd_net -net mandelpod_irq \
    [get_bd_pins MandelPod_axi_0/irq] \
  ...
  assign_bd_address -offset 0xB0000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs MandelPod_axi_0/s_axi/reg0] -force
  # Mandelbrot AXI master reaches PS DDR (low 2 GB) via the HP0_FPD slave port.
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces MandelPod_axi_0/m_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
